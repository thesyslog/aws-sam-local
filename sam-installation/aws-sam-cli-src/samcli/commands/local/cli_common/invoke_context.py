...
class ContainersInitializationMode(Enum):
    ...
    SRE_LOOGER.error( "file: samcli.commands.local.cli_common.invoke_context -- class " +  SRE_CLASS_NAME)
...
class InvokeContext:
    ...
    def __enter__(self) -> "InvokeContext":
        ...
        SRE_LOOGER.error( "file: samcli.commands.local.cli_common.invoke_context --  def " +  SRE_DEF_NAME)
