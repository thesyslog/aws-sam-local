...
def get_application_dir():
    ...
    SRE_LOOGER.error( "here  file: samcli.commands.local.cli_common.options --  def " +  SRE_DEF_NAME + "path: " + Path(click.get_app_dir("AWS SAM", force_posix=True)))
...
def get_default_layer_cache_dir():
    ...
    SRE_LOOGER.error( "here file: samcli.commands.local.cli_common.options --   def " +  SRE_DEF_NAME)
